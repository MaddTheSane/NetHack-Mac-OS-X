...
STATIC_DCL void done_object_cleanup(void);
...
STATIC_PTR int CFDECLSPEC vanqsort_cmp(const genericptr,
                                       const genericptr);
STATIC_DCL int set_vanq_order(void);
...
#ifdef DUMPLOG
STATIC_DCL void dump_plines(void);
#endif
